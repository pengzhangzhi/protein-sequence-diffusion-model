...
def _load_model_and_alphabet_core_v2(model_data,**kwargs):
    ...
    model = ESM2(
        ...
        max_time_steps = kwargs.get("max_time_steps") or 1000
    )
    return model, alphabet, state_dict


def load_model_and_alphabet_core(model_name, model_data, regression_data=None,strict=False,**kwargs):
    ...
    model.load_state_dict(model_state, strict=regression_data is not None and strict)
